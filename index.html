    ...
    <section class="experience">
      ...
      <div class="job">
        ...
        <div class="job-details">
          ...
          <p>Launched the MVP of the NIL Valuation Platform, delivering verified valuations for 500+ athletes and increasing school adoption by 40%. Automated onboarding workflows to cut manual operations by 70%, led an 8-member data team in agile execution, and improved product delivery speed and data accuracy by 25%.</p>
        </div>
      </div>
      ...
      <div class="job">
        ...
        <div class="job-details">
          ...
          <p>Led compensation product strategy impacting 200+ employees and $600K in monthly payouts, improving accuracy and compliance. Developed performance dashboards, reduced downtime by 75%, and accelerated product delivery through cross-functional alignment.</p>
        </div>
      </div>
      ...
      <div class="job">
        ...
        <div class="job-details">
          ...
          <p>Managed financial operations, vendor payments, and client presentations. Coordinated meetings and events to improve stakeholder relationships and drive project delivery.</p>
        </div>
      </div>
    </section>
