      ...
      <div class="hero-content">
        <div class="hero-text">
          ...
          <div class="cta-buttons">
            ...
            <a href="#" class="btn btn-secondary" onclick="alert('Resume download would be available here')">
        ...
        <div class="hero-profile">
          <div class="profile-card">
            <div class="profile-image-container">
              ...
              <img src="https://via.placeholder.com/280" alt="Monisha Sood" class="profile-image">
            </div>
            <h3 class="profile-name">Monisha Sood</h3>
            <p class="profile-title">Product Manager | MBA '26</p>
            <div class="profile-links">
              <a href="#" class="profile-link primary" onclick="alert('Resume download would be available here')">
      ...
      <div class="footer-content">
        <div class="footer-brand">
          ...
          <div class="social-links">
            ...
            <a href="mailto:monisha.sood@wisc.edu" class="social-link" title="Email">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                <polyline points="22,6 12,13 2,6"></polyline>
              </svg>
            </a>
            <a href="#" class="social-link" onclick="alert('Resume download would be available here')" title="Resume">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                <polyline points="14 2 14 8 20 8"></polyline>
                <line x1="16" y1="13" x2="8" y2="13"></line>
